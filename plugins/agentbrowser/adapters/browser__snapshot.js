// Capability adapter for `browser.control / browser__snapshot`, run in Core's plugin sandbox.
...
// snapshot. The ids round-trip: browser__tabs returns agent-browser's own tab
