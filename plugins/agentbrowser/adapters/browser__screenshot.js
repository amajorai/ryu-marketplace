// Capability adapter for `browser.control / browser__screenshot`, run in Core's plugin sandbox.
...
// Same tab-targeting gap as browser__snapshot: agent-browser screenshots the
...
if (
	...
	await callNamed("agentbrowser__agent_browser_tab_switch", {
		tab: input.tab_id,
	});
}
