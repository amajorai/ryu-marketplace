// Co-located contract test for the `ghost` plugin (plugins-store/plugins/ghost).
// Zero-dependency, runnable with:  node --test plugins-store/plugins/ghost/plugin.test.mjs
//
